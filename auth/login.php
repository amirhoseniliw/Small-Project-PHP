...
if (isset( $_SESSION['status'])) {
    ...
    isset($_POST['btn'])){
        global $pdo;
    $query = 'SELECT * FROM php_project.users WHERE email = ? && password= ? ';
    ...
    <section id="app">
        ...
        <section style="height: 100vh; background-color: #138496;" class="d-flex justify-content-center align-items-center">
            <section style="width: 20rem;">
                ...
                <section class="bg-light my-0 px-2"><small class="text-danger"><?php   if ($error !==' ') {
                    echo $error;
                } ?></small></section>
                <form class="pt-3 pb-1 px-2 bg-light rounded-bottom" action="<?= url('auth/login.php') ?>" method="post">
                    ...
                    <section class="mt-4 mb-2 d-flex justify-content-between">
                        ...
                        <a class="" href="<?= asset('auth/register.php')?>" >register</a>
                    </section>
                </form>
            </section>
        </section>
